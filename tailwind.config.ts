  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        traverseUpLeft: "traverseUpLeft 10s ease-in-out infinite alternate",
        traverseUpRight: "traverseUpRight 12s ease-in-out infinite alternate",
        traverseDownRight: "traverseDownRight 8s ease-in-out infinite alternate"
      }
    }
